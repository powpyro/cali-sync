        ...
        if (targetWindow) {
          targetWindow.document.body.innerHTML = `
            <div class="card" style="border-color: #f43f5e;">
              ...
              <p style="font-size: 11px; color: #94a3b8;">Veuillez vous assurer d'avoir copié le code de <strong>Code_v14.gs</strong> dans Apps Script et exécuté la fonction <code>autoriserGoogleDocsPermissions</code> une fois.</p>
            </div>
          `;
        }
